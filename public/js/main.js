...
function applyAdvancedSettingsVisibility(showAdvanced) {
  ...
  settingsLayout?.classList.toggle('advanced-visible', Boolean(showAdvanced))
}
...
function initializeAdvancedSettingsToggle() {
  ...
  if (toggle.dataset.boundAdvancedToggle === 'true') return
